 ...
 *
 * Requires a Personal Token from the seller account:
 * https://build.envato.com/create-token/
 * (permissions that allow viewing sales / author endpoints)
 */
...
/**
 * Returns sale details if the code is valid for this author token, or null if not found.
 */
